  ...
  <div class="module-small footer-widgets bg-dark-reverse">
        ...
        <footer class="footer bg-dark">
          <div class="container">
            <div class="row">
              <div class="col-sm-12">
                <p class="copyright">&copy; <?php  echo date("Y"); ?> <?php  bloginfo("name"); ?>, All Rights Reserved | <a href="/privacy-policy">Privacy Policy</a>| <a href="mailto:info@ngocommunicef.org"><i class="fa fa-envelope"></i></a> | <a href="http://twitter.com/ngocommunicef" target="blank"><i class="fa fa-twitter"></i></a></p> 
              </div>
