	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'text',
				'name' => esc_html__( 'Event address', 'metabox-online-generator' ),
			),
			array(
			...
			array(
				...
				'name' => esc_html__( 'Directions', 'metabox-online-generator' ),
				'type' => 'textarea',
				'rows' => '3',
				//'desc' => esc_html__( 'directions to the event', 'metabox-online-generator' ),
			),
			array(
				'id' => $prefix . 'recurs',
